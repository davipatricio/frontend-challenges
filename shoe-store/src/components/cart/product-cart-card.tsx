  ...
  return (
    <div className="flex flex-wrap gap-2 mt-4">
      ...
      <div className="flex flex-col p-2 w-full max-w-96">
        <div className={clsx('flex justify-between flex-wrap text-zinc-900 dark:text-zinc-200', dmSans.className)}>
          <p className="font-bold text-xl">{product.brand}</p>
          <p className="font-medium text-lg">${product.price}</p>
        </div>

        <p className="text-gray-700 text-lg mb-2 dark:text-gray-200">{product.name}</p>
